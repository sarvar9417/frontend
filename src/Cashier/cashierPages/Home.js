                            ...
                            if (client._id === section.client) {
                                ...
                                return (
                                    <tr key={key} >
                                        ...
                                        <td><Link to={`/cashier/payment/${client._id}`} > {client.lastname} {client.firstname} {client.fathername} </Link></td>
                                        <td>{client.id}</td>
                                        <td>+{client.phone}</td>
                                        <td> <Link to={`/cashier/clienthistory/${section._id}`} > {section.name} </Link></td>
