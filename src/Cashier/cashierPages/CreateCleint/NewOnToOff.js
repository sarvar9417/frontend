...
export const NewOnToOff = () => {
    ...
    const getClient = useCallback(async () => {
        try {
            ...
            setForm({
                ...
                payDone: 'to`lanmagan',
                doctorComment: ' ',
                doctorSummary: 'Xulosa berilmagan',
                doctorDone: 'tasdiqlanmagan',
                intact: data.intact,
                position: "kelgan",
            })
        } catch (e) {
    ...
    const createHandler = async () => {
        try {
            const position = await request(`/api/clientonline/${clientId}`, 'PATCH', { position: "kelgan" })
